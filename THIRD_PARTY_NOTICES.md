...
저장소의 그래픽은 프로젝트용 SVG, CSS, Canvas 도형과 2026-07-19에 Codex built-in imagegen으로 생성한 게임 아이콘 PNG master로 구성됩니다. 아이콘은 외부 이미지·상표·캐릭터 reference 없이 생성하고 저장소 안에서 AVIF·WebP·PNG·OG로 최적화했습니다. prompt, chroma key 제거, 수동 검수와 파일 예산은 `docs/ASSET_PROVENANCE.md`에 기록합니다.
